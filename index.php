    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="post-card mb-4" >
         <a href="post.php?post_id=<?php echo $post_id?>"><img class="card-img-top"  src="images/<?php echo $post_image ?>" alt="Card image cap" /></a>
          ...
          <div class="card-body p-3 m-3 shadow-lg" style="background-color:white; margin-bottom:200px">
      ...
      <ul class="pagination justify-content-center mb-4">
          ...
          for($i=1;$i<=$pages;$i++){
              ...
              echo "<a class='page-link bg-warning' href='index.php?page=$i'>$i</a>";
                  
              }else{
              echo "<li class='page-item'>";
              echo "<a class='page-link' style='background-color:#e8e8e8' href='index.php?page=$i'>$i</a>";
              }
          }
