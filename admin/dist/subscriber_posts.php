...
?>
    <body class="sb-nav-fixed">
                        ...
                        <tbody>
                           <?php
                            ...
                            while($row=mysqli_fetch_assoc($query)){
                                ...
                                echo "<td><a href='admin_posts.php?post_id=$post_id&status=published'>Publish</a></td>";
                                ...
                                echo "<td><a onClick=\"javascript: return confirm('Are you sure, you want to reset views?');\" href='admin_posts.php?reset=$post_id'>$post_views</a></td>";
                                echo "</tr>";
        ...
        echo "<h1 style='text-align:center'> NO POSTS SUBMITED</h1>";
